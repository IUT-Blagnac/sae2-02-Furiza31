...
| 1 | link:SAE_2.02_Java/src/main/eraser/EraserUn.java[ici]  | Java   | Lisibilité du code / Qualité du code / Efficacité / Temps d'exécution 
| 2 |  link:SAE_2.02_Java/src/main/eraser/EraserDeux.java[ici] | Java | Sobriété numérique / Temps d'exécution / Lisibilité du code
| 3 |  link:SAE_2.02_Java/src/main/eraser/EraserTrois.java[ici] | Java | Lisibility du code
| 4 | link:SAE_2.02_Python/eraserUn.py[ici] | Python | Lisibilité du code / Qualité du code / Efficacité / Temps d'exécution
| 5 | link:SAE_2.02_Python/eraserDeux.py[ici] | Python | Sobriété numérique / Temps d'exécution / Lisibilité du code
| 6 | link:SAE_2.02_Python/eraserTrois.py[ici] | Python | Lisibility du code
|==========================================================================
...
. Aller voir ce document: link:rapport/analyse.adoc[anlyse.adoc]

=== Références

- En python: la librairie **__timeit__**.
- Génération du text via ce link:analyse/code_a_analyser/generationText.py[programme].
- Complexité algorithmique du Regex: link:https://stringfixer.com/fr/Regular_Expression[Stringfiexer]
- Calculer la comlexité d'un algorithme: link:https://info.blaisepascal.fr/nsi-complexite-dun-algorithme[Complexité]
